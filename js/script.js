  ...
  collection :
  {
    ...
    items : [
        ...
        data : [
			...
			{name : "actor", value : "Toni Pérez", prompt : "Actor"},
			{name : "image", value: "https://vignette.wikia.nocookie.net/lotr/images/8/87/Ringstrilogyposter.jpg/revision/latest?cb=20070806215413", prompt: "Movie image"}
        ]
	    },
	    {
        ...
        data : [
			...
			{name : "image", value: "https://pics.filmaffinity.com/the_hunger_games_mockingjay_part_2-413766198-large.jpg", prompt: "Movie image"}
        ]
	    },
	    {
        ...
        data : [
			...
			{name : "image", value: "https://pics.filmaffinity.com/game_of_thrones_tv_series-293142110-large.jpg", prompt: "Movie image"}
        ]
	    }
    ]
  }
